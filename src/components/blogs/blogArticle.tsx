...
const BlogArticle: React.FC = () => {
  return (
    <article>
      <img src="/images/blogs/blog-1.png" alt="img" className="w-full thumb__img" />
      <div className="first__para">
        ...
        <p>
          ...
          will pay, and the exact amount your receiver will get.
        </p>
        <p>
          ...
          moon subway tile fam, cronut cray put a bird on it why is a common
          is kombucha gentrify available for your next project pok pok.
        </p>
      </div>
      <SlideUp>
        <blockquote>
          <b>
            ...
            air plant meditation palo santo asymmetrical is salvia blue
            bottle. 3 wolf moon subway tile in the next project in the last
            season fam."
          </b>
          <p>
            <span />
      ...
      <div className="flex flex-wrap -mx-4 img__gallery">
        <div className="md:w-6/12 px-4">
          <img src="/images/blogs/blog-5.png" alt="img" className="w-full" />
        </div>
        <div className="md:w-6/12 px-4 mt-4 md:mt-0">
          <div className="relative">
            <img src="/images/blogs/blog-4.png" alt="img" className="w-full" />
            <a
      ...
      <SlideUp className="flex justify-between flex-wrap items-center share__option">
