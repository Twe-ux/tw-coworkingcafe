      ...
      <article className="service__details py__130">
        <div className="container">
          <img
            ...
            alt="img"
            className="w-full thumb__img"
          />
          <div className="first__para pt__60">
            <SlideUp>
              <h2 className="t__54">Business Analysis And Solution Program</h2>
            </SlideUp>
            <p>
          ...
          <div className="second__para pt__60">
            <div className="flex flex-wrap -mx-4 justify-between items-center">
              <SlideUp className="md:w-6/12 px-4">
                <img
              ...
              <SlideUp className="md:w-5/12 px-4 mt-4 md:mt-0">
                <div>
                  <h4 className="t__28">
          ...
          <div className="thred__para pt__50">
            ...
            <p>
              EO is the process of optimizing a website to improve its
              visibility in search engine results pages (SERPs). Digital
              marketing agencies use SEO techniques to enhance a website's
              ranking, drive organic traffic, and increase its online presence.
              Content is king in the digital world. Agencies produce
              high-quality content, including blog posts, videos, infographics,
              and more, to engage and educate the target audience
            </p>
          </div>
          <div className="fourt__para">
            ...
            <p>
              ...
              like new again, inside &amp; out. This is a full-day service.Need
              interior and exterior detailing services? At Eco Car Cafe, we
              offer signature auto detail packages to refresh your interior and
              exterior. We created our convenient package bundles so you can get
              the best of both.
            </p>
          </div>
        </div>
